		...
		if ( $data ) {
			...
			$popup = '
				<script type="text/javascript">
					...
					html_popup1 += "<div id=\'confirmButtons\'><div class=\'button confirm-yes\'>' . esc_html__('Upgrade', 'jobcareer') . '</div><div class=\'button confirm-no\'>' . esc_html__('Cancel', 'jobcareer') . '</div><br class=\'clear\'></div></div></div>";
